...
aws ecr get-login-password | docker login --username AWS --password-stdin http://$aws_account_and_region
...
aws ecr describe-images --repository-name $ecr_repo_name --image-ids imageTag=$verNo
